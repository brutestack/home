...
| ГКЛ перегородка горизонтальная (над проёмом) | 50 мм, длина 600 мм, отгораживает шкаф от проёма |
...
const GKL4_W = 0.6       // Длина перегородки над проёмом (м)
...
- [x] Горизонтальная перегородка над проёмом в спальню (600×50 мм, отгораживает шкаф)
