...
| Шаг стоек | 600 мм |
| Примыкание перегородки спальни | 1180 мм от левого края колонны 2 |
...
| Элемент | Параметры |
|---------|-----------|
| ГКЛ перегородка горизонтальная | Двойная (50+75+50 мм, ПН 75 между слоями), от колонны 2 до колонны 1, один проём 900 мм сразу за колонной 2 |
