...
Одинарная вертикальная перегородка от колонны 1 до нижней стены, разделяющая ванную и спальню.

| Параметр | Значение |
|----------|----------|
| Общая длина | 2480 мм (IWALL_LEN - COL_H = 2630 - 150) |
| Толщина перегородки | 100 мм (профиль ПН/ПС 100×40/50) |
| Толщина с ГКЛ | 125 мм (100 + 12.5×2) |
| Шаг стоек | 600 мм |
...
Стойки пронумерованы от колонны 1 до нижней стены:
- **Стойка 1** — у колонны 1
- **Стойки 2–4** — с шагом 600 мм
- **Стойка 5** — у нижней стены
...
| Доборка у стены (ванная) | 80×2500×12.5 мм | 1 шт | Со стороны ванной |
| Доборка сверху | 2480×300×12.5 мм | 2 шт | 1 × 2 стороны |
| Доборка (спальня) | 600×2500×12.5 мм | 1 шт | Смещение вразбежку |

#### Каркас

| Элемент | Размер | Кол-во | Примечание |
|---------|--------|--------|------------|
| Профиль ПН 100×40 (пол) | 2480 мм | 1 шт | На всю длину |
| Профиль ПН 100×40 (потолок) | 2480 мм | 1 шт | На всю длину |
| Профиль ПС 100×50 | 2720 мм | 5 шт | Шаг 600 мм |
