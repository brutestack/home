...
- **Каркас перегородки** — схема каркаса двойной перегородки спальни с раздвижной дверью + спецификация материалов
...
| Толщина перегородки | 150 мм (50+50+50) |
...
| Элемент | Параметры |
|---------|-----------|
| ГКЛ перегородка горизонтальная | Двойная (50+50+50 мм), от колонны 2 до колонны 1, два проёма 900 мм (один сразу за колонной 2, второй примыкает к вертикальной перегородке) |
...
const GKL_GAP = 0.05     // Зазор между слоями (м)
...
│   ├── partition-frame.tsx  # Каркас перегородки спальни (SVG, внешний/внутренний слой, разрезы, горизонтальная часть)
...
- [x] Схема каркаса перегородки спальни (внешний слой, внутренний слой, разрезы)
