...
| **Л5.Сх2** | Вид со стороны коридора |
| **Л5.Сх3** | Вид сверху |
| **Л5.Сх4** | Разрез |
...
Двойная горизонтальная перегородка от колонны 2 до колонны 1 с дверным проёмом и откатной дверью.

| Параметр | Значение |
|----------|----------|
| Общая длина с колоннами | 2440 мм (COL_W + HORIZ_LEN + COL_W) |
| Длина перегородки | 2040 мм (между колоннами) |
| Толщина перегородки | 175 мм (50+75+50), ПН 75 между слоями |
| Дверной проём | 900×2000 мм |
| Позиция проёма | 250–1150 мм (после стойки у колонны 2) |
| Высота бруса (механизм) | 2100 мм от пола |
| Высота ПН над дверью | 2000 мм от пола |
| Шаг стоек | 600 мм |
| Примыкание перегородки спальни | 1150 мм от левого края колонны 2 (совпадает с краем дверного проёма) |

#### Схемы каркаса

- **Вид со стороны ванной** — внешний слой, дверной проём слева (около колонны 2)
- **Вид со стороны коридора** — внутренний слой (зеркальный), дверной проём справа
- **Вид сверху** — структура двойной перегородки с примыканием перегородки спальни
- **Разрез перегородки** — двойной каркас с ПН 75 между слоями
- **Пунктирные линии** — примыкание перегородки спальни (175 мм)

#### Нумерация стоек

Все стойки пронумерованы уникально на обеих сторонах перегородки:
- **Слой коридора:** стойки 1–5
- **Слой ванной:** стойки 6–9

#### Раскладка ГКЛ

| Элемент | Размер | Кол-во | Примечание |
|---------|--------|--------|------------|
| Лист основной | 1200×2500×12.5 мм | 2 шт | От границы проёма, с вырезом × 2 стороны |
| Доборка у колонны 1 | 90×2500×12.5 мм | 2 шт | Закрывает колонну 1 |
| Доборка сверху | 1175×300×12.5 мм | 2 шт | Над основным листом |
| Доборка сверху (у кол.1) | 90×300×12.5 мм | 2 шт | Над колонной 1 |
| Лист над дверью | 1175×800×12.5 мм | 2 шт | Закрывает колонну 2 и механизм |

#### Каркас

| Элемент | Размер | Кол-во | Примечание |
|---------|--------|--------|------------|
| Профиль ПН 50×40 (пол, после проёма) | 1090 мм | 2 шт | После проёма × 2 слоя |
| Профиль ПН 50×40 (пол, у кол.2) | 50 мм | 2 шт | Под стойкой у колонны 2 × 2 слоя |
| Профиль ПН 50×40 (потолок) | 2040 мм | 2 шт | На всю длину × 2 слоя |
| Профиль ПН 75×40 (между слоями) | 2040 мм | 2 шт | Пол + потолок для зазора 75 мм |
| Профиль ПН 50×40 (над дверью) | 900 мм | 2 шт | Только над проёмом, низ на 2000 мм × 2 слоя |
| Профиль ПН 50×40 (стык ГКЛ) | 1090 мм | 2 шт | Центр на 2500 мм × 2 слоя |
| Профиль ПС 50×50 | 2720 мм | 10 шт | 5 стоек × 2 слоя |
| Брус (на всю перегородку) | 2040×70×50 мм | 1 шт | Между слоями, низ на 2100 мм, для механизма |

### Каркас вертикальной перегородки ванной

Одинарная вертикальная перегородка от верхней стены до нижней стены, разделяющая ванную и спальню.

| Параметр | Значение |
|----------|----------|
| Общая длина | 2630 мм (от стены до стены) |
| Толщина перегородки | 50 мм (профиль ПН 50×40 / ПС 50×50) |
| Толщина с ГКЛ | 75 мм (50 + 12.5×2) |
| Шаг стоек | 400 мм |
| Высота | 2800 мм (до потолка) |

#### Схемы каркаса

- **Вид со стороны ванной** — внешний вид с раскладкой ГКЛ
- **Вид со стороны спальни** — зеркальный вид, раскладка ГКЛ вразбежку (смещение 600 мм)
- **Вид сверху** — структура одинарной перегородки с профилями
- **Разрез** — поперечный разрез перегородки
