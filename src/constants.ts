...
// === ГКЛ перегородки ===
// Горизонтальная двойная: от колонны 2 до колонны 1, 50+50+50мм
export const GKL_LAYER = 0.05;
export const GKL_GAP = 0.05;
export const GKL_T = GKL_LAYER * 2 + GKL_GAP; // 150мм

// Вертикальная (ванная): от колонны до нижней стены, 100мм
export const GKL2_T = 0.1;

// Вертикальная двойная: от верхней стены до ванной, 50+50+50мм
